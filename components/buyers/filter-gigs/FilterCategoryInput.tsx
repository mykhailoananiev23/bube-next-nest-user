...
import { InitSearchWordContext, SearchWordContext, SearchWordProps } from "../../../contexts/searchwordContext";
...
export const FilterCategoryInput = ({ className }: any) => {
  ...
  return (
    <div className={className + " rounded-[10px] p-[40px] bg-white"}>
      <div className="flex justify-between ">
        ...
        <button
          className="text-[#0071BC] text-[16px] leading-[30px] font-[500] hover:text-[#bd80d1]"
          onClick={clearSearchWordContext}
        >
          Clear All
        </button>
      </div>
