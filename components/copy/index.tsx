...
function Code({ children }: any) {
  ...
  return (
    <pre className="inline-flex font-mono text-sm py-2.5 px-4 overflow-x-auto max-w-full mb-4 bg-gray-100 text-black border rounded-full">
      <span>{children}</span>
      <span className="ml-5">
