...
export const CreateGigCard = () => {
  ...
  async function handleSubmit(values: any, { setSubmitting }: any) {
    ...
    // const user = await ApiService.getData({ url: `users/harsh@example.com` });
  ...
  return (
    <div>
      <ToastContainer />
      <Formik
        initialValues={gigId ? initialValuesGig : initialValues}
